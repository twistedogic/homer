# Capability: pwa-manifest

## Purpose

Defines the requirements for the PWA web app manifest and associated HTML metadata that make Homer installable and recognisable as a progressive web app.
