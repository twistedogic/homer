# Capability: add-to-home-screen

## Purpose

Defines the requirements for the Add to Home Screen install button in the header, including platform detection and the Android native install prompt flow.
